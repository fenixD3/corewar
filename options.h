...
static t_op		g_op[17] = {
	...
	{"ldi", 3, {T_REG | T_DIR | T_IND, T_DIR | T_REG, T_REG}, 10, 25, 1, DIR_SHRT_LEN},
	{"sti", 3, {T_REG, T_REG | T_DIR | T_IND, T_DIR | T_REG}, 11, 25, 1, DIR_SHRT_LEN},
	{"fork", 1, {T_DIR, 0, 0}, 12, 800, 0, DIR_SHRT_LEN},
	{"lld", 2, {T_DIR | T_IND, T_REG, 0}, 13, 10, 1, DIR_LONG_LEN},
	{"lldi", 3, {T_REG | T_DIR | T_IND, T_DIR | T_REG, T_REG}, 14, 50, 1, DIR_SHRT_LEN},
